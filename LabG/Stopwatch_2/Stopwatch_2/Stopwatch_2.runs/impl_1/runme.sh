...
HD_PWD='C:/Users/conor/Year 3/Semester 2/3C7 Digital Systems Design/LabG/Stopwatch_2/Stopwatch_2/Stopwatch_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stop_watch_test_2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stop_watch_test_2.tcl -notrace
