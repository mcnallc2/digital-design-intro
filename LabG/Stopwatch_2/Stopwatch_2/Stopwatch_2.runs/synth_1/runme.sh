...
HD_PWD='C:/Users/conor/Year 3/Semester 2/3C7 Digital Systems Design/LabG/Stopwatch_2/Stopwatch_2/Stopwatch_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stop_watch_test_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stop_watch_test_2.tcl
