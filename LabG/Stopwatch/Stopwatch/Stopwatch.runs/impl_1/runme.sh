...
HD_PWD='C:/Users/conor/Year 3/Semester 2/3C7 Digital Systems Design/LabG/Stopwatch/Stopwatch/Stopwatch.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stop_watch_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stop_watch_test.tcl -notrace
