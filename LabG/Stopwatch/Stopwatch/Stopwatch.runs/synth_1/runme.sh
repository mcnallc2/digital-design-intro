...
HD_PWD='C:/Users/conor/Year 3/Semester 2/3C7 Digital Systems Design/LabG/Stopwatch/Stopwatch/Stopwatch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stop_watch_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stop_watch_test.tcl
